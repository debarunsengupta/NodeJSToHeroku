...
app.intent('getCRUDPerms',(conv,{sObject,profileName})=>{
	...
	return getCrudInfo(sObject,profileName).then((resp)=>{
		...
		conv.ask(new SimpleResponse({speech:"CRUD permission for "+sObject+" on"+" profileName is "+strResult,text:"CRUD permission for "+sObject+" on"+" profileName is "+strResult}));
